...
```{r univariate dotplots 2, message=FALSE, fig.width=10, fig.height=6}
library(ggplot2)
library(reshape2)
...
selFeatures <- featureSelection(X, yName, method = "lasso",
                                nFeatRep = 10, nLassoFolds = 5, thresh = 2, alpha = 1)
print(selFeatures)
...
modVal <- modelValidation(X, yName, nFolds = 5, nReps = 10, nPerms = 10, 
