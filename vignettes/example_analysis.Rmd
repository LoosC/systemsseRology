...
# Define colors
my_colors = list(class = c(RSTR = "red", LTB = "blue"))
...
opts_plot <- list(df_features = df_features,
                  ...
                  color_featuers = "antigen", # according to which property (defined in df_features) the features should be color-coded
                  colors = my_colors) 
...
opts = list(n_folds = 5, rf_trials = 0,  pt_trials = )
